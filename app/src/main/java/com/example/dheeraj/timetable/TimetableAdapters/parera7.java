...
public class parera7 extends AppCompatActivity {
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            seTimetable=mylistofDocuments.get(7).toObject(SeTimetable.class);
                            ArrayList<String> subject;
                            String[] times={"10:15","11:15","12:15","1:15","1:45","2:45","3:45","4:45"};

                            RecyclerViewAdapter recyclerViewAdapter = new RecyclerViewAdapter(parera7.this, logosauto, seTimetable.getMon(), "auto",times);
                            recyclerView.setAdapter(recyclerViewAdapter);
                            RecyclerViewAdapter recyclerViewAdapter1 = new RecyclerViewAdapter(parera7.this, logoscivil, seTimetable.getTue(), "civil",times);
                            recyclerView1.setAdapter(recyclerViewAdapter1);
                            RecyclerViewAdapter recyclerViewAdapter2 = new RecyclerViewAdapter(parera7.this, logoscomp, seTimetable.getWen(), "comp",times);
                            recyclerView2.setAdapter(recyclerViewAdapter2);
                            RecyclerViewAdapter recyclerViewAdapter3 = new RecyclerViewAdapter(parera7.this, logosentc, seTimetable.getThur(), "entc",times);
                            recyclerView3.setAdapter(recyclerViewAdapter3);
                            RecyclerViewAdapter recyclerViewAdapter4 = new RecyclerViewAdapter(parera7.this, logosinstru, seTimetable.getfri(), "instru",times);
