...
public class RecyclerviewSE extends AppCompatActivity {
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            RecyclerViewAdapter recyclerViewAdapter = new RecyclerViewAdapter(RecyclerviewSE.this, logosauto, seTimetable.getMon(), "auto",times);
                            recyclerView.setAdapter(recyclerViewAdapter);
                            RecyclerViewAdapter recyclerViewAdapter1 = new RecyclerViewAdapter(RecyclerviewSE.this, logoscivil, seTimetable.getTue(), "civil",times);
                            recyclerView1.setAdapter(recyclerViewAdapter1);
                            RecyclerViewAdapter recyclerViewAdapter2 = new RecyclerViewAdapter(RecyclerviewSE.this, logoscomp, seTimetable.getWen(), "comp",times);
                            recyclerView2.setAdapter(recyclerViewAdapter2);
                            RecyclerViewAdapter recyclerViewAdapter3 = new RecyclerViewAdapter(RecyclerviewSE.this, logosentc, seTimetable.getThur(), "entc",times);
                            recyclerView3.setAdapter(recyclerViewAdapter3);
                            RecyclerViewAdapter recyclerViewAdapter4 = new RecyclerViewAdapter(RecyclerviewSE.this, logosinstru, seTimetable.getfri(), "instru",times);
        ...
        public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
            ...
            holder.Title.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(RecyclerviewSE.this,BatchtimetableSE.class));
                }
            });
            ...
            public ViewHolder(@NonNull View itemView) {
              ...
              //  imageList=(ImageView)itemView.findViewById(R.id.ivtimetable);
                ...
                Title.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent( RecyclerviewSE.this,BatchtimetableSE.class );
