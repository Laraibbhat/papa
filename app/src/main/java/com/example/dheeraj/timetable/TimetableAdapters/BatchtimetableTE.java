...
public class BatchtimetableTE extends AppCompatActivity {
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            RecyclerViewAdapter recyclerViewAdapter = new RecyclerViewAdapter(BatchtimetableTE.this, logosauto, seTimetable.getMon(), "auto",times);
                            recyclerView.setAdapter(recyclerViewAdapter);
                            RecyclerViewAdapter recyclerViewAdapter1 = new RecyclerViewAdapter(BatchtimetableTE.this, logoscivil, seTimetable.getTue(), "civil",times);
                            recyclerView1.setAdapter(recyclerViewAdapter1);
                            RecyclerViewAdapter recyclerViewAdapter2 = new RecyclerViewAdapter(BatchtimetableTE.this, logoscomp, seTimetable.getWen(), "comp",times);
                            recyclerView2.setAdapter(recyclerViewAdapter2);
                            RecyclerViewAdapter recyclerViewAdapter3 = new RecyclerViewAdapter(BatchtimetableTE.this, logosentc, seTimetable.getThur(), "entc",times);
                            recyclerView3.setAdapter(recyclerViewAdapter3);
                            RecyclerViewAdapter recyclerViewAdapter4 = new RecyclerViewAdapter(BatchtimetableTE.this, logosinstru, seTimetable.getfri(), "instru",times);
