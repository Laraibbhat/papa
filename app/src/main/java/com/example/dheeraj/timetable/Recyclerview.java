...
public class Recyclerview extends AppCompatActivity {
    ...
    public void setadap() {
        ...
        String[] subject={"TOC","DBMS","SEPM","BREAK","ISEE","CN","PRAC","PRAC"};
        String[] times={"10:15","11:15","12:15","1:15","1:45","2:45","3:45","4:45"};


        RecyclerViewAdapter recyclerViewAdapter = new RecyclerViewAdapter(this, logosauto, subject, "auto",times);
        recyclerView.setAdapter(recyclerViewAdapter);
        RecyclerViewAdapter recyclerViewAdapter1 = new RecyclerViewAdapter(this, logoscivil, subject, "civil",times);
        recyclerView1.setAdapter(recyclerViewAdapter1);
        RecyclerViewAdapter recyclerViewAdapter2 = new RecyclerViewAdapter(this, logoscomp, subject, "comp",times);
        recyclerView2.setAdapter(recyclerViewAdapter2);
        RecyclerViewAdapter recyclerViewAdapter3 = new RecyclerViewAdapter(this, logosentc, subject, "entc",times);
        recyclerView3.setAdapter(recyclerViewAdapter3);
        RecyclerViewAdapter recyclerViewAdapter4 = new RecyclerViewAdapter(this, logosinstru, subject, "instru",times);
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
        ...
        public RecyclerViewAdapter(Context context, int[] images, String[] EventNames, String department,String[] waqt) {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder
        {
            ...
            public TextView Title,Fees,Timee
